...
class DataTrainingArguments:
    ...
    combo: Optional[bool] = field(
        default=False, metadata={"help": "apply combo augmentation"}
    )
    delete_match_words: Optional[bool] = field(
        default=False, metadata={"help": "delete matching words"}
    )
    delete_non_match_words: Optional[bool] = field(
        default=False, metadata={"help": "delete non-matching words"}
    )
