...
NONMATCH=$8
PROB=0.10
CUDA_VISIBLE_DEVICES=2 python run_finetune_baseline.py \
    --do_train \
	...
	--augment_prob=$PROB \
	--combo=$COMBO \
	--delete_match_words=$MATCH \
	--delete_non_match_words=$NONMATCH \
    --output_dir /ceph/dmittal/di-student/reports/baseline/abtbuy-MATCH-$MATCH-NONMATCH-$NONMATCH-COMBO-$COMBO-PROB-$PROB-AUG-$AUG$BATCH-$LR-${MODEL##*/}/ \
